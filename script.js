...
$("document").ready(function () {
	...
	function createList(e) {
		...
		if (opt.value == "please select item") {

			document.querySelector(".descrition").innerHTML = null;
		}
		else {
			var s = opt.value;
			document.querySelector(".descrition").innerHTML = `<div class="panel panel-default">
